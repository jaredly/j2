...
function peg$parse(input, options) {
  ...
  var peg$f14 = function(target, suffixes_drop) {
  ...
  var peg$f21 = function(expr, suffix) {
  return {
    type: "TemplatePair",
    loc: myLocation(),
    expr,
