...
function peg$parse(input, options) {
  ...
  var peg$f53 = function(args, inner) {
  return {
    type: "TVars",
    loc: myLocation(),
    args,
  ...
  var peg$f55 = function(label, hash, bound, default_) {
  return {
    type: "TBArg",
    loc: myLocation(),
    label,
  ...
  var peg$f56 = function(decorators, inner) {
  return {
    type: "TDecorated",
    loc: myLocation(),
    decorators: decorators.map(element => element[0]),
  ...
  var peg$f57 = function(text, hash) {
  return {
    type: "TRef",
    loc: myLocation(),
    text,
  ...
  var peg$f58 = function(left, right_drop) {
  ...
  var peg$f59 = function(top, right) {
  return {
    type: "TRight",
    loc: myLocation(),
    top,
  ...
  var peg$f61 = function(label, typ) {
  return {
    type: "TArg",
    loc: myLocation(),
    label: label ? label[0] : label,
  ...
  var peg$f63 = function(args, result) {
  return {
    type: "TLambda",
    loc: myLocation(),
    args,
  ...
  function peg$parseRecordKeyValue() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s3 !== peg$FAILED) {
        s4 = peg$parse_();
        s5 = peg$parseDecoratedExpression();
        if (s5 !== peg$FAILED) {
          peg$savedPos = s0;
          s0 = peg$f46(s1, s5);
        } else {
