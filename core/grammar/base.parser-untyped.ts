...
function peg$parse(input, options) {
  ...
  var peg$e19 = peg$literalExpectation("alias", false);
  var peg$e20 = peg$classExpectation([["0", "9"], ["a", "z"], ["A", "Z"], "_"], false, false);
  ...
  var peg$f16 = function(name, hash) {
  return {
    type: "AliasItem",
    loc: myLocation(),
    name,
  ...
  var peg$f17 = function(text, hash) {
  return {
    type: "Identifier",
    loc: myLocation(),
    text,
  ...
  var peg$f20 = function(first, rest_drop) {
  ...
  var peg$f22 = function(op_drop, inner) {
  ...
  var peg$f33 = function(wrap, suffix) {
  return {
    type: "TemplatePair",
    loc: myLocation(),
    wrap,
  ...
  var peg$f36 = function(decorators_drop, inner) {
  ...
  var peg$f38 = function(text, hash) {
  return {
    type: "DecoratorId",
    loc: myLocation(),
    text,
  ...
  var peg$f40 = function(label, arg) {
  return {
  ...
  var peg$f43 = function(text, payload) {
  return {
    type: "Enum",
    loc: myLocation(),
    text,
  ...
  var peg$f47 = function(decorators, text, payload) {
  return {
    type: "TagDecl",
    loc: myLocation(),
  ...
  var peg$f52 = function(args, inner) {
  return {
  ...
  var peg$f54 = function(conds, block) {
  return {
    type: "IfYes",
    loc: myLocation(),
    conds,
  ...
  var peg$f56 = function(args, res, body) {
  return {
    type: "Lambda",
    loc: myLocation(),
    args,
  ...
  var peg$f63 = function(name, typ, expr) {
  return {
    type: "LetPair",
    loc: myLocation(),
    name,
  ...
  var peg$f65 = function(name, hash) {
  return {
    type: "PName",
    loc: myLocation(),
    name,
  ...
  var peg$f71 = function(just) {
  return just;
};
  var peg$f72 = function(hash) {
  return {
    type: "PHash",
    loc: myLocation(),
    hash
  ...
  var peg$f73 = function(decorators, inner) {
  return {
    type: "PDecorated",
    loc: myLocation(),
    decorators: decorators.map(element => element[0]),
  ...
  var peg$f74 = function(text, payload) {
  return {
    type: "PEnum",
    loc: myLocation(),
    text,
  ...
  var peg$f78 = function(key, value) {
  return {
    type: "RecordKeyValue",
    loc: myLocation(),
    key,
  ...
  var peg$f82 = function(key, value, default_) {
  return {
  ...
  var peg$f83 = function(target, cases) {
  return {
    type: "Switch",
    loc: myLocation(),
    target,
  ...
  var peg$f85 = function(inner, args_drop) {
  ...
  var peg$f87 = function(args, inner) {
  return {
    type: "TVars",
    loc: myLocation(),
    args,
  ...
  var peg$f89 = function(label, hash, bound, default_) {
  return {
    type: "TBArg",
    loc: myLocation(),
    label,
  ...
  var peg$f90 = function(decorators, inner) {
  return {
    type: "TDecorated",
    loc: myLocation(),
    decorators: decorators.map(element => element[0]),
  ...
  var peg$f91 = function(text, hash) {
  return {
    type: "TRef",
    loc: myLocation(),
    text,
  ...
  var peg$f93 = function(left, right_drop) {
  ...
  var peg$f94 = function(top, right) {
  return {
    type: "TRight",
    loc: myLocation(),
    top,
  ...
  var peg$f95 = function(items, open) {
  return {
    type: "TParens",
    loc: myLocation(),
    items,
  ...
  var peg$f96 = function(label, typ) {
  return {
    type: "TArg",
    loc: myLocation(),
    label: label ? label[0] : label,
  ...
  var peg$f98 = function(args, result) {
  return {
    type: "TLambda",
    loc: myLocation(),
    args,
  ...
  var peg$f100 = function(name, typ) {
  return {
    type: "TypePair",
    loc: myLocation(),
    name,
