...
function peg$parse(input, options) {
  ...
  var peg$e47 = peg$literalExpectation("type", false);
  ...
  var peg$f17 = function() { allComments.push([location(), text()]); };
  ...
  var peg$f22 = function(wrap, suffix) {
  return {
    type: "TemplatePair",
    loc: myLocation(),
    wrap,
  ...
  var peg$f25 = function(decorators_drop, inner) {
  ...
  var peg$f27 = function(text, hash) {
  return {
    type: "DecoratorId",
    loc: myLocation(),
    text,
  ...
  var peg$f29 = function(label, arg) {
  return {
  ...
  var peg$f40 = function(vbls, body) {
  return {
    type: "TypeVariables",
    loc: myLocation(),
    vbls,
  ...
  var peg$f42 = function(vbl, bound) {
  return {
    type: "TypeVbl",
    loc: myLocation(),
    vbl,
  ...
  var peg$f47 = function(inner, args_drop) {
  ...
  var peg$f49 = function(args, inner) {
  return {
    type: "TVars",
    loc: myLocation(),
    args,
  ...
  var peg$f51 = function(label, hash, bound, default_) {
  return {
    type: "TBArg",
    loc: myLocation(),
    label,
  ...
  var peg$f52 = function(decorators, inner) {
  return {
    type: "TDecorated",
    loc: myLocation(),
    decorators: decorators.map(element => element[0]),
  ...
  var peg$f53 = function(text, hash) {
  return {
    type: "TRef",
    loc: myLocation(),
    text,
  ...
  var peg$f54 = function(left, right_drop) {
  ...
  var peg$f55 = function(top, right) {
  return {
    type: "TRight",
    loc: myLocation(),
    top,
  ...
  var peg$f57 = function(label, typ) {
  return {
    type: "TArg",
    loc: myLocation(),
    label: label ? label[0] : label,
  ...
  var peg$f59 = function(args, result) {
  return {
    type: "TLambda",
    loc: myLocation(),
    args,
