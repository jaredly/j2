...
function peg$parse(input, options) {
  ...
  var peg$e36 = peg$literalExpectation("type", false);
  ...
  var peg$f42 = function(label, typ) {
  return {
    type: "TArg",
    loc: myLocation(),
    label: label ? label[0] : label,
  ...
  var peg$f44 = function(args, result) {
  return {
    type: "TLambda",
    loc: myLocation(),
    args,
