...
function peg$parse(input, options) {
  ...
  var peg$f1 = function(target, parens_drop) {
  return parens_drop.length === 0 ? target : {
    type: "Apply",
    loc: myLocation(),
    target,
    parens: parens_drop
  ...
  var peg$f10 = function() { allComments.push([location(), text()]); };
