import {Loc, File, Toplevel, Expression, Apply, Number, Boolean, TemplateString, Ref, UnresolvedRef, RefKind, Id, DecoratedExpression, Decorator, DecoratorArg, Type, TRef, TLambda, TExpr, String, Sym, TApply, TVars, TAdd, TSub, TOr, TDecorated} from './typed-ast';
...
export type Visitor<Ctx> = {
    ...
    Expression_Apply?: (node: Apply, ctx: any) => null | false | Expression | [Expression | null, Ctx],
    Expression_Number?: (node: Number, ctx: any) => null | false | Expression | [Expression | null, Ctx],
    Expression_Boolean?: (node: Boolean, ctx: any) => null | false | Expression | [Expression | null, Ctx],
    Expression_TemplateString?: (node: TemplateString, ctx: any) => null | false | Expression | [Expression | null, Ctx],
    Expression_Ref?: (node: Ref, ctx: any) => null | false | Expression | [Expression | null, Ctx],
    Expression_DecoratedExpression?: (node: DecoratedExpression, ctx: any) => null | false | Expression | [Expression | null, Ctx],
    Type_TRef?: (node: TRef, ctx: any) => null | false | Type | [Type | null, Ctx],
    Type_TLambda?: (node: TLambda, ctx: any) => null | false | Type | [Type | null, Ctx],
    TExpr_Number?: (node: Number, ctx: any) => null | false | TExpr | [TExpr | null, Ctx],
    TExpr_String?: (node: String, ctx: any) => null | false | TExpr | [TExpr | null, Ctx],
    DecoratorArg_Type?: (node: Type, ctx: any) => null | false | DecoratorArg | [DecoratorArg | null, Ctx]
}
...
export const transformRef = <Ctx>(node: Ref, visitor: Visitor<Ctx>, ctx: Ctx): Ref => {
        ...
        switch (node.kind.type) {
            ...
            default: {
                ...
                const updatedNode$kind$1node = transformRefKind(node.kind, visitor, ctx);
                changed1 = changed1 || updatedNode$kind$1node !== node.kind;
                        updatedNode$kind = updatedNode$kind$1node;
                    }
        }
                if (changed1) {
                    updatedNode =  {...updatedNode, loc: updatedNode$loc, kind: updatedNode$kind};
                    changed0 = true;
                }
            }
...
export const transformTRef = <Ctx>(node: TRef, visitor: Visitor<Ctx>, ctx: Ctx): TRef => {
        ...
        switch (node.ref.type) {
            case 'Unresolved': {
                        updatedNode$ref = transformUnresolvedRef(node.ref, visitor, ctx);
            ...
            default: {
                ...
                const updatedNode$ref$1node = transformRefKind(node.ref, visitor, ctx);
                ...
                changed1 = changed1 || updatedNode$loc !== node.loc;
                if (changed1) {
                    updatedNode =  {...updatedNode, ref: updatedNode$ref, loc: updatedNode$loc};
                    changed0 = true;
                }
            }
