...
export const Lambda = ({
    ...
    return (
        <span>
            ...
            <ClickSide
                store={store}
                path={path.concat([{ cid, idx, punct: (punct += 2) }])}
            >
                fn
            </ClickSide>
            <ClickSide
            ...
            <ClickSide
                store={store}
                path={path.concat([{ cid, idx, punct: (punct += 1) }])}
            >
                )
            </ClickSide>
            {item.res ? (
            ...
            <ClickSide
                store={store}
                path={path.concat([{ cid, idx, punct: (punct += 3) }])}
            >
                {' '}
                =&gt;
            </ClickSide>
